...
files_to_combine = ['SFR_profiles_ap50ckpc_',
 ...
 'MH2_profiles_ap50ckpc_',
 'Mcoldgas_profiles_ap50ckpc_',
 'Z_gas_profiles_ap50ckpc_',
 #'FeH_gas_profiles_ap50ckpc_',
 'Mstar_profiles_ap50ckpc_', 
 'Mdust_profiles_ap50ckpc_',
 'NumberPart0_profiles_ap50ckpc_', 
 'NumberPart4_profiles_ap50ckpc_', 
 'Disp_HI_profiles_ap50ckpc_', 
 'Disp_H2_profiles_ap50ckpc_',
 'Disp_Cool_profiles_ap50ckpc_',  
 'Disp_HI_h10_profiles_ap50ckpc_',  
 'Disp_H2_h10_profiles_ap50ckpc_',  
 'Disp_Cool_h10_profiles_ap50ckpc_',
 'Disp_HI_h5_profiles_ap50ckpc_',
 'Disp_H2_h5_profiles_ap50ckpc_',
...
ids = np.loadtxt(out_dir + dir_output_data +  'GalaxyProperties_reduced_z' + str(ztarget) + '.txt', unpack = True, usecols = [0])
